...
<div class="w3-row">
    <div class="w3-white w3-round-large cc">
        ...
        <div class="checkout_area">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="checkout_details_area mt-50 ml-3 clearfix">
                                ...
                                <form action="{{ route('login') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 offset-2 mb-4">
                                                <label>
                        ...
                        <div class="col-md-6 col-lg-5 ml-lg-auto w3-round-medium">
                            <div class="order-details-confirmations w3-border w3-round-large">
                                <div class="cart-page-heading">
