...
<footer class="footer_area">
    ...
    <a class="w3-margin w3-jumbo w3-round-medium w3-light-gray" target="_blank" href="https://api.whatsapp.com/send?phone=17179370305&text=Hello Dr. Micheal Adonis, I really like you product as seen on your, will like to have some" style="width: 12%; position: fixed; bottom: 10px; right: 7px; z-index: 10003"><i class="fa fa-whatsapp w3-text-green w3-jumbo center" style="justify-content:center; display: flex"></i></a>
</footer>
<!-- ****** Footer Area End ****** -->
